<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contactPage.aspx.cs" Inherits="project_5.contactPage" %>
                ...
                <div id="form">
                    <div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="exampleFormControlTextarea1" runat="server" rows="3"></textarea>
                        </div>
                        <br />
                        <br />
